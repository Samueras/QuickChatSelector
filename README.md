...
Quick Chat Selector makes switching between a character's chats fast. It adds a chat selector to the character management drawer, shows the most recent chats right under each card in the character list, and adds a right-click chat picker to the HotSwaps favorite avatars. It can also rename your chats with short, descriptive labels generated by your LLM.
...
### ⭐ Chat Picker on HotSwaps Favorite Avatars

Right-click (or long-press on touch) a favorite avatar in the HotSwaps strip on top of the character management panel to open a compact chat picker menu at the cursor and jump straight to that character's chat.
...
Right-click a HotSwaps favorite avatar for a compact chat picker:

![Hotswap chat picker](Media/hotswap-chat-picker.png)
...
| Chat picker on HotSwaps favorite avatars (right-click / long-press) | on | The context menu on HotSwap avatars |
